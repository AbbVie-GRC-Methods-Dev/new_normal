...
project_dir = '/fioSeq/projects/output/dna/hugo_2016/ucla_samples_as_tumor_only/'
...
# We need to format the MAF, save to the correct location, and add the final column to the dataframe.
#
#hugo_maf = pd.read_csv(data_splits.loc[0,'input_maf'], sep='\t')
#
